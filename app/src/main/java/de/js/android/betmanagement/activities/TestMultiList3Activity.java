...
public class TestMultiList3Activity extends Activity {
    // Connection detector
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_multi_list3);
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            alert.showAlertDialog(TestMultiList3Activity.this, "Internet Connection Error",
    ...
    class LoadSingleTrack extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(TestMultiList3Activity.this);
