...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        fakeHeader.setTitle(R.string.pref_header_example);
        getPreferenceScreen().addPreference(fakeHeader);

        // weiter folgen Beispiel Einstellungen
        //TODO überlegen welche einstellungen wir brauchen
        ...
        //bindPreferenceSummaryToValue(findPreference("offline_modus"));
