...
import de.js.android.betmanagement.helper.AlertDialogManager;
import de.js.android.betmanagement.helper.ConnectionDetector;
import de.js.android.betmanagement.helper.JSONParser;

public class TestMultiList2Activity extends ListActivity {
    // Connection detector
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_multi_list2);
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            alert.showAlertDialog(TestMultiList2Activity.this, "Internet Connection Error",
        ...
        lv.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int arg2,
                ...
                Intent i = new Intent(getApplicationContext(), TestMultiList3Activity.class);
    ...
    class LoadTracks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(TestMultiList2Activity.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            TestMultiList2Activity.this, tracksList,
